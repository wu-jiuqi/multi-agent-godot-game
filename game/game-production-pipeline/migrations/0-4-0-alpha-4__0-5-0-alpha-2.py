#!/usr/bin/env python3
"""Plan the non-destructive v0.4.0-alpha.4 to v0.5.0-alpha.2 migration."""
...
def common():
    ...
    spec = importlib.util.spec_from_file_location("_game_pipeline_art_v05_alpha2_from_alpha4", path)
