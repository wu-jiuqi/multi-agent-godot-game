#!/usr/bin/env python3
"""Plan the v0.5.0-alpha.4 to v0.5.0-alpha.5 migration."""
...
FROM_VERSION = "0.5.0-alpha.4"
SUPPORTED_FROM_FRAMEWORK_DIGESTS = {"4049b4a7e65053de27a1fe558370c6110082fb4bb624d5456087f76b1016bfb6"}
