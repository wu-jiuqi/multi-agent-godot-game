...
class PluginPackageTests(unittest.TestCase):
    def test_manifest_and_skill_entries_match_release(self) -> None:
        ...
        self.assertRegex(manifest["version"], r"^0\.4\.0-alpha\.4(?:\+codex\.[0-9A-Za-z.-]+)?$")
    ...
    def test_installation_docs_use_the_personal_marketplace_selector(self) -> None:
        ...
        repository_documentation = {
            "release notes": REPO_ROOT / "docs" / "releases" / "v0.4.0-alpha.4.md",
            "test guide": REPO_ROOT / "docs" / "releases" / "v0.4.0-alpha.4-test-guide.md",
        }
    ...
    def test_windows_encoding_guidance_is_explicit_and_safe(self) -> None:
        ...
        repository_paths = (
            REPO_ROOT / "docs" / "releases" / "v0.4.0-alpha.4.md",
            REPO_ROOT / "docs" / "releases" / "v0.4.0-alpha.4-test-guide.md",
        )
